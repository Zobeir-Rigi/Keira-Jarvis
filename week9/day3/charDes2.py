...
"" '' # To Do: Task 3: Complete the code block below to print a list of converted numbers as letters
"" '' # The question marks indicates where the code syntax is missing 
