...
"" '' # Task 1: 
"" '' # To DO: run the code below to explain what the type() function is used for
...
"" '' # Task 2 (Make/Create): 
"" '' # 1. Produce five examples of numeric datatypes
num4 = 10; NUM5 = 10 
"" '' # 2. Produce five examples of string datatypes

"" '' # Write the code for task 2 below this line
